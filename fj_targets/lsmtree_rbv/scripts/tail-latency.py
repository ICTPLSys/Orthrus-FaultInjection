...
lsmtree_throughput_scee, lsmtree_latency_scee = parse_json("latency_vs_pXX_scee.json")
lsmtree_throughput_raw, lsmtree_latency_raw = parse_json("latency_vs_pXX_raw.json")
lsmtree_throughput_rbv, lsmtree_latency_rbv = parse_json("latency_vs_pXX_rbv.json")
