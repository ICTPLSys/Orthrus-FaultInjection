...
parser.add_argument("--input-raw", default="memory_status_raw.log")
parser.add_argument("--input-scee", default="memory_status_scee.log")
parser.add_argument("--input-rbv", default="memory_status_rbv.log")
