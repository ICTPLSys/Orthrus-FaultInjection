...
int main() {
    ...
    for (int _ = 0; _ < kNTests; ++_) {
        ...
        fprintf(stderr, "INSERT %d keys, throughput = %.3f Mops/s\n",
                kThreads * kStart, (kThreads * kStart * 1.0) / ms_count);
        ...
        fprintf(stderr, "65M READ, 20M UPDATE, 5M INSERT workload finished!\n");
        double read_mops =
